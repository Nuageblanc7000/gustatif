 ...
 */
final class Version20220829092536 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE restaurant (id INT AUTO_INCREMENT NOT NULL, city_id INT NOT NULL, user_id INT NOT NULL, schedule_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, adress VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, cover VARCHAR(255) NOT NULL, INDEX IDX_EB95123F8BAC62AF (city_id), INDEX IDX_EB95123FA76ED395 (user_id), UNIQUE INDEX UNIQ_EB95123FA40BC2D5 (schedule_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE timetable (id INT AUTO_INCREMENT NOT NULL, schedule_id INT DEFAULT NULL, open TIME DEFAULT NULL, close TIME DEFAULT NULL, day INT NOT NULL, INDEX IDX_6B1F670A40BC2D5 (schedule_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE restaurant ADD CONSTRAINT FK_EB95123FA40BC2D5 FOREIGN KEY (schedule_id) REFERENCES schedule (id)');
        ...
        $this->addSql('ALTER TABLE timetable ADD CONSTRAINT FK_6B1F670A40BC2D5 FOREIGN KEY (schedule_id) REFERENCES schedule (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE restaurant DROP FOREIGN KEY FK_EB95123FA40BC2D5');
        ...
        $this->addSql('ALTER TABLE timetable DROP FOREIGN KEY FK_6B1F670A40BC2D5');
